...
LABEL org.opencontainers.image.description="This is the controls message client to capture pub/sub messages and react accordingly for OpenRMF OSS"
LABEL org.opencontainers.image.vendor="Cingulara LLC and Tutela LLC"
LABEL org.opencontainers.image.title="OpenRMF OSS Controls Message Client"